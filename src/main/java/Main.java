/*
 * Problem:
 * - Create a functional interface called ConcatStringFunction that has a method called apply that takes 
 * in a variable amount of String arguments and returns a String values.
 */
